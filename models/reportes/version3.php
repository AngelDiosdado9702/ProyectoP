...
move_uploaded_file($guardado, 'imagenes/'.$nombrearchivo);
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="../../views/css/reportes/version3.css">
	</head>
	<body>
		...
		<div class="textencima">
			...
			<table class="recibimosmateriales" >
				<tr>
					<td class="reciseg2"><?php  echo $mostrar['tapas']?></td>
					<td class="reciseg3"><?php  echo $mostrar['env_multi']?></td>
				</tr>
			</table>
			<?php
	...
	<div class="inforeporte">
		<div class="dropdown">
			...
			<li>
				...
				<li>
					<a href="../../views/admin/reportes/excelRep3.php">Reportes</a>
				</li>
				<li>
