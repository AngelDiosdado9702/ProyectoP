...
<body>
                ...
                <nav class="nav-menu">
                    ...
                    <ul class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <li>
                                <a href="../reportes/excelRep.php">Reportes</a>
                            </li>
                            <li>
    ...
    <div>
        <center>
            <h2>REPORTES POR MES(versión 1)</h2> 
            <br><br>
    ...
    <div class="outer-container">
        ...
        <br><br>
        <div>
            <form  method="POST"  name="frm" action="excelRep.php">
            <ul class="nav-menu">
                <div >
    ...
    <div>   
        <center>
            <form method="POST" enctype="multipart/form-data" action="../../../models/reportes/seleccionar.php">
             <div class="outer-container">
                <div>
                    <br><br>
                    <label>Selecciona la imagen del reporte:</label>
                    <br>
                    <font color="white">
