...
<body>
            ...
            <nav class="nav-menu">
                    ...
                    <ul class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <li>
                                <a href="../reportes/excelRep5.php">Reportes</a>
                            </li>
                            <li>
    ...
    <div>
        <center>
            <h2>REPORTES POR MES(versión 5)</h2> 
            <br><br>
    ...
    <div class="outer-container">
        ...
        <div>
            <form  method="POST"  name="frm" action="excelRep5.php">
            <ul class="nav-menu">
                <div >
    ...
    <div>   
        <center>
            <form method="POST" enctype="multipart/form-data" action="../../../models/reportes/version5.php">
             <div class="outer-container">
                <div>
                    <br><br>
                ...
                <font color="black">
                    <form action ="version5.php" method="post"> 
                    <input type="black" name="codigo" placeholder="Ingrese ID de recoleción" required>
                </font>
