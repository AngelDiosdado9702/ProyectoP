...
<body>
                ...
                <img src="../../imagenes/logo.ico" alt="GRUPO PROMESA" class="nav-menu-logo">
                    <ul class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <li>
                                <a href="../reportes/excelRep3.php">Reportes</a>
                            </li>
                            <li>
    ...
    <div>
        <center>
            <h2>REPORTES POR MES (versión 3)</h2> 
            <br><br>
    ...
    <div class="outer-container">
        ...
        <div>
            <form  method="POST"  name="frm" action="excelRep3.php">
            <ul class="nav-menu">
                <div >
    ...
    <div>   
        <center>
            <form method="POST" enctype="multipart/form-data" action="../../../models/reportes/version3.php">
             <div class="outer-container">
                <div>
                    <br><br>
