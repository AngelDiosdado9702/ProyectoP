...
<body>
                ...
                <nav class="nav-menu">
                    ...
                    <ul class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <li>
                                <a href="../reportes/excelRep2.php">Reportes</a>
                            </li>
                            <li>
    ...
    <div>
        <center>
            <h2>REPORTES POR MES (versión 2)</h2> 
            <br><br>
    ...
    <div class="outer-container">
        ...
        <div>
            <form  method="POST"  name="frm" action="excelRep2.php">
            <ul class="nav-menu">
                <div >
    ...
    <div>   
        <center>
            <form method="POST" enctype="multipart/form-data" action="../../../models/reportes/version2.php">
             <div class="outer-container">
                <div>
                    <br><br>
